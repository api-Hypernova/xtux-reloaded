...
int main(int argc, char *argv[])
{
    ...
    strncpy(server.name, "»Ąрī« Clan Server", 32);
    ...
    strncpy(game.map_name, "ai_test.map", NETMSG_STRLEN);
    ...
    /* Initialize networking. TRY to use server.port, but return the actual
